...
//import MobilePaymentsSdk.AuthorizationManager
//import MobilePaymentsSdk.result.*
...
class MainActivity : ReactActivity() {
  ...
  override fun onResume() {
    ...
    val callbackReference = authorizationManager.authorize(accessToken, locationId) { result ->
      when (result) {
        is Result.Success -> {
